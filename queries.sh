...
echo "$($PSQL "SELECT  DISTINCT(name) FROM teams INNER JOIN games ON teams.name = games.winner OR teams.name = games.opponent WHERE round = 'Eighth-Final' AND year = 2014")"
